...
using Olinuck.Dario.Estanteria;
...
namespace Supermercado
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (!(est2 + g))// esta no la carga verificar
            {
                Console.WriteLine("No se pudo agregar el producto al estante!!!");
            }
            if (!(est2 + g1))
            ...
            Console.WriteLine("---Hasta acá Funciona---?");
        ...
        public static int OrdenarProductos(Producto a, Producto b)
        {
            int auxRet = 0;
